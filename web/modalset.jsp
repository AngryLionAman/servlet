<%-- 
    Document   : modalset
    Created on : 19 Dec, 2019, 1:11:15 PM
    Author     : AngryLion
--%>
...
<html lang="en">
    <head>
        ...
        <title>Upload Modal set - inquiryhere.com</title>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                            <div class="row">   
                                ...
                                <div style="height:auto;background-color: #e1e8e8;">
                                    <form name="optionalQuestion" action="SaveModalSetQuestion" method="get">   
                                        <div id="correctAnswer" style="background-color:#00c;padding-bottom: 8px;padding-top: 8px;text-align: left;">
                                            <div class="boxHeading" style="padding-left: 10px;">
                                                Exam Of : <input type="text" name="exam_of">                                                 
                                            </div>                                            
                                        </div>
                                        <div id="correctAnswer" style="background-color: #e0e0e0;padding-bottom: 8px;padding-top: 8px;text-align: left;">
                                            <div class="boxHeading" style="padding-left: 10px;">
                                                Set No. : <input type="text" name="set_no">                                                 
                                            </div>                                            
                                        </div>
                                        ...
                                        <div id="correctAnswer" style="background-color:#00c;padding-bottom: 8px;padding-top: 8px;text-align: left;">
                                            <div class="boxHeading" style="padding-left: 10px;">
                                                Correct Ans : <input type="text" name="correctAnswer" required="">                                                 
                                            </div>                                            
                                        </div>
