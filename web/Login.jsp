                                    ...
                                    <%
                                        ...
                                        if (ErrorMsg != null) {
                                            if (ErrorMsg.equalsIgnoreCase("valid")) {
                                                out.println("<center><b style=color:red;>Invalid UserName or PassWord</b></center>");
                                            }
                                            if (ErrorMsg.equalsIgnoreCase("logout")) {
                                                out.println("<center><b style=color:red;>Thanks for using our service. Please visit again</b></center>");
                                            }
                                            if (ErrorMsg.equalsIgnoreCase("submitAns")) {
                                                out.println("<center><b style=color:red;>Please Login First</b></center>");
                                            }
