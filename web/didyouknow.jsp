                            ...
                            <div class="row">
                                <%
                                    ...
                                    try {
                                        ...
                                        String query1 = "SELECT SQL_CALC_FOUND_ROWS * FROM didyouknow LIMIT " + iPageNo + "," + showRows + "";
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div>
                                                    ...
                                                    %>
                                                    <a href="didyouknow.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>&sl=<%=sl%>"> << Previous</a>
                                                    <%
                                                        }
                                                        for (i = ((cPage * totalRecords) - (totalRecords - 1)); i <= (cPage * totalRecords); i++) {
                                                            if (i == ((iPageNo / showRows) + 1)) {%>
                                                    <a href="didyouknow.jsp?iPageNo=<%=i%>&sl=<%=sl%>" style="cursor:pointer;color:red"><b><%=i%></b></a>
                                                            <%
                                                            } else if (i <= totalPages) {
                                                            %>
                                                    <a href="didyouknow.jsp?iPageNo=<%=i%>&sl=<%=sl%>"><%=i%></a>
                                                    <%
                                                            }
                                                        }
                                                        if (totalPages > totalRecords && i < totalPages) {
                                                    %>
                                                    <a href="didyouknow.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>&sl=<%=sl%>"> >> Next</a>
                                                    <%
                                                            }
                                                        }
                                                    %>
