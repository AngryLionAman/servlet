                                ...
                                <form>
                                    ...
                                    <div class="themeBox" style="height:auto;">
                                        ...
                                        <div class="boxHeading">
                                            <a href="D_Blog.jsp?blog_sub=<%=rs1.getString("blog_subject").replaceAll(" ", "-")%>&Blog_Id=<%=rs1.getString("blog_id")%>&sl=<%=sl%>"><%=rs1.getString("blog_subject")%></a>
                                        </div>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div>
                                                    ...
                                                    %>
                                                    <a href="quotes.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>&sl=<%=sl%>"> << Previous</a>
                                                    <%
                                                        }
                                                        for (i = ((cPage * totalRecords) - (totalRecords - 1)); i <= (cPage * totalRecords); i++) {
                                                            if (i == ((iPageNo / showRows) + 1)) {%>
                                                    <a href="quotes.jsp?iPageNo=<%=i%>&sl=<%=sl%>" style="cursor:pointer;color:red"><b><%=i%></b></a>
                                                            <%
                                                            } else if (i <= totalPages) {
                                                            %>
                                                    <a href="quotes.jsp?iPageNo=<%=i%>&sl=<%=sl%>"><%=i%></a>
                                                    <%
                                                            }
                                                        }
                                                        if (totalPages > totalRecords && i < totalPages) {
                                                    %>
                                                    <a href="quotes.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>&sl=<%=sl%>"> >> Next</a>
                                                    <%
                                                            }
                                                        }
                                                    %>
