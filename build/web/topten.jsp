                            ...
                            <div class="row">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        String query1 = "SELECT SQL_CALC_FOUND_ROWS * FROM topten LIMIT " + iPageNo + "," + showRows + "";
                                ...
                                <form>
                                    ...
                                    <div class="themeBox" style="height:auto;">
                                        ...
                                        <div class="boxHeading">
                                            <a href="top_ten.jsp?t=<%=rs1.getString("tt_title").replaceAll(" ", "-")%>&t_id=<%=rs1.getInt("tt_id")%>"><%=convertStringUpperToLower(rs1.getString("tt_title"))%></a>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div>
                                                    ...
                                                    %>
                                                    <a href="topten.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>&sl=<%=sl%>"> << Previous</a>
                                                    <%
                                                        }
                                                        for (i = ((cPage * totalRecords) - (totalRecords - 1)); i <= (cPage * totalRecords); i++) {
                                                            if (i == ((iPageNo / showRows) + 1)) {%>
                                                    <a href="topten.jsp?iPageNo=<%=i%>&sl=<%=sl%>" style="cursor:pointer;color:red"><b><%=i%></b></a>
                                                            <%
                                                            } else if (i <= totalPages) {
                                                            %>
                                                    <a href="topten.jsp?iPageNo=<%=i%>&sl=<%=sl%>"><%=i%></a>
                                                    <%
                                                            }
                                                        }
                                                        if (totalPages > totalRecords && i < totalPages) {
                                                    %>
                                                    <a href="topten.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>&sl=<%=sl%>"> >> Next</a>
                                                    <%
                                                            }
                                                        }
                                                    %>
