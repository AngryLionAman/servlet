...
public class getAllBlog {
     ...
     */
    public List<blogPojo> blogByLimit(int limit, Connection con) throws SQLException, ClassNotFoundException {
     ...
     * @throws java.lang.ClassNotFoundException
     */
    public List<blogPojoById> blogByBlogId(int blogid, Connection con) throws SQLException, ClassNotFoundException {
     ...
     * @throws java.lang.ClassNotFoundException
     */
    public List<blogPojo> blog(Connection con) throws SQLException, ClassNotFoundException {
