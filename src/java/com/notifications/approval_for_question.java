 ...
 * @author AngryLion
 */
@WebServlet(name = "approval_for_question", urlPatterns = {"/approval_for_question"})
public class approval_for_question extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<QuestionForApprovalPojo> questionForApprobval = null;
        ...
        try {
            ...
            request.setAttribute("notifiaction_id", comment_id);
            request.setAttribute("questionForApprobval", questionForApprobval);
